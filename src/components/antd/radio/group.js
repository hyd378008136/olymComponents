        ...
        if (props.options && props.options.length > 0) {
            children = props.options.map((option, index) => {
                if (typeof option === 'string') {
                    ...
                    return (React.createElement(Radio, { key: index, disabled: option.disabled || this.props.disabled, value: option.value, onChange: this.onRadioChange, checked: this.state.value === option.value }, option.label));
                }
            });
        }
