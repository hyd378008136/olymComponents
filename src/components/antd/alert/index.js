...
export default class Alert extends React.Component {
    ...
    render() {
        let { closable, description, type, prefixCls = 'ant-alert', message, closeText, showIcon, banner, className = '', style, } = this.props;
        // banner模式默认有 Icon
        ...
        const closeIcon = closable ? (React.createElement("a", { onClick: this.handleClose, className: `${prefixCls}-close-icon` }, closeText || React.createElement(Icon, { type: "cross" }))) : null;
        return this.state.closed ? null : (React.createElement(Animate, { component: "", showProp: "data-show", transitionName: `${prefixCls}-slide-up`, onEnd: this.animationEnd },
            React.createElement("div", { "data-show": this.state.closing, className: alertCls, style: style },
