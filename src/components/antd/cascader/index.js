...
export default class Cascader extends React.Component {
    ...
    render() {
        ...
        const clearIcon = (allowClear && !disabled && value.length > 0) || state.inputValue ? (React.createElement(Icon, { type: "cross-circle", className: `${prefixCls}-picker-clear`, onClick: this.clearSelection })) : null;
