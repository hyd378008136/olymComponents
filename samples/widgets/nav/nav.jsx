          ...
          this.props.navArr.map(item =>
            item.isCat ?
              ...
              <li className="nav__item" key={item.label.toString()}>
                <Link to={item.href} activeClassName="nav__link--active"
                      className={classnames('nav__link', {'has-subnav': item.children})}
                      onClick={this.slideToggle}><Icon type={item.icon}/>{item.label}</Link>
                {item.children &&
                <ol className="subnav">
                  {item.children.map(item =>
                    <li className="subnav__item" key={item.label.toString()}>
                      <Link to={item.href} className="subnav__link"
                            activeClassName="nav__link--active">{item.label}</Link>
                    </li>
                  )}
                </ol>
                }
