...
const customColumns = [
  ...
  {orderNo:-1,dataIndex:"key",title:"key"},
...
class TableSample extends Component{
  ...
  customCtn =()=> {
    let customCtn = [];
    customCtn.push(<Button style={{float:'right',marginLeft:10}} onClick={this.ctn1} size="small">自定义按钮1</Button>);
    customCtn.push(<Button style={{float:'right',marginLeft:10}} onClick={this.ctn1} size="small">自定义按钮2</Button>);
    return customCtn;
  };
  render(){
