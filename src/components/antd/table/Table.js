...
export default class Table extends React.Component {
    constructor(props) {
        ...
        this.renderTable = (contextLocale) => {
            ...
            return (React.createElement(RcTable, Object.assign({ key: "table" }, restProps, { onRow: this.onRow, components: this.components, prefixCls: prefixCls, data: data, columns: columns, showHeader: showHeader, className: classString, expandIconColumnIndex: expandIconColumnIndex, expandIconAsCell: expandIconAsCell, emptyText: () => locale.emptyText })));
        };
    ...
    render() {
        ...
        const data = this.getCurrentPageData();
        const table = (React.createElement(LocaleReceiver, { componentName: "Table", defaultLocale: defaultLocale.Table }, this.renderTable));
