...
export default class Badge extends React.Component {
    render() {
        ...
        const scrollNumber = hidden ? null : (React.createElement(ScrollNumber, { prefixCls: scrollNumberPrefixCls, "data-show": !hidden, className: scrollNumberCls, count: displayCount, title: count, style: styleWithOffset }));
