    ...
    render() {
        ...
        if (src && this.state.isImgExist) {
            ...
            if (childrenNode || this.state.scale !== 1) {
                ...
                children = (React.createElement("span", { className: `${prefixCls}-string`, ref: span => this.avatarChildren = span, style: childrenStyle }, children));
            }
            else {
                children = (React.createElement("span", { className: `${prefixCls}-string`, ref: span => this.avatarChildren = span }, children));
            }
        }
        return (React.createElement("span", Object.assign({}, others, { className: classString }), children));
    }
}
Avatar.defaultProps = {
