...
export default class Header extends React.Component {
    ...
    getYearSelectElement(year) {
        ...
        return (React.createElement(Select, { size: fullscreen ? 'default' : 'small', dropdownMatchSelectWidth: false, className: `${prefixCls}-year-select`, onChange: this.onYearChange, value: String(year), getPopupContainer: () => this.calenderHeaderNode }, options));
    }
    ...
    getMonthSelectElement(month, months) {
        ...
        return (React.createElement(Select, { size: fullscreen ? 'default' : 'small', dropdownMatchSelectWidth: false, className: `${prefixCls}-month-select`, value: String(month), onChange: this.onMonthChange, getPopupContainer: () => this.calenderHeaderNode }, options));
    }
    render() {
        ...
        const typeSwitch = (React.createElement(Group, { onChange: this.onTypeChange, value: type, size: size },
